...
Revision ID: 4a6e83fc0e3c
Revises: bb0ce49579a8
Create Date: 2025-03-17 21:47:59.966799
...
revision: str = '4a6e83fc0e3c'
down_revision: Union[str, None] = 'bb0ce49579a8'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_orders_clerk_id'), 'orders', ['clerk_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_orders_clerk_id'), table_name='orders')
